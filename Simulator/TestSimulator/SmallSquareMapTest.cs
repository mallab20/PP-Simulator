...
namespace TestSimulator
{
    public class SmallSquareMapTests
    {
        ...
        [InlineData(0, 0, Direction.Down, 0, 0)] // Point stays the same if out of bounds
        [InlineData(0, 8, Direction.Left, 0, 8)] // Point stays the same if out of bounds
        [InlineData(19, 10, Direction.Right, 19, 10)] // Point stays the same if out of bounds
